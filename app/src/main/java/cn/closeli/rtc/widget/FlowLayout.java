...
public class FlowLayout extends ViewGroup {
    ...
    private Map<String, FrameLayout> remoteVideoViews;
    ...
    private Map<String, Integer> compute(int flowWidth) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            Log.i("FlowLayout", "rowsWidth" + rowsWidth + "rowsMaxHeight" + rowsMaxHeight);
            //换行
...
//            child.setTag(new Rect(rowsWidth - childWidth + marginParams.leftMargin, columnHeight + marginParams.topMargin, rowsWidth - marginParams.rightMargin, columnHeight + childHeight - marginParams.bottomMargin));
    ...
    public interface OnItemClickListener {
        void onItemClick(String id, FrameLayout view);
    }
    ...
    public Map<String, FrameLayout> getRemoteVideoViews() {
        return remoteVideoViews;
    }

    public void setRemoteVideoViews(Map<String, FrameLayout> remoteVideoViews) {
        this.remoteVideoViews = remoteVideoViews;
    }
}
